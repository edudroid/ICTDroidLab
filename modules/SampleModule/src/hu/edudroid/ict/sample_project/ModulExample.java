...
public class ModulExample extends Module {
  ...
  public ModulExample(  Preferences prefs,  Logger logger,  PluginCollection pluginCollection,  TimeServiceInterface timeservice,  ThreadSemaphore threadsemaphore){
