...
public class Constants {
	...
	public static final String INTENT_ACTION_CALL_METHOD = "hu.edudroid.ict.plugin_polling_answer";
	public static final String INTENT_ACTION_DESCRIBE = "hu.edudroid.ict.plugin_polling_answer";
	public static final String INTENT_ACTION_REQUEST_DESCRIPTION = "hu.edudroid.ict.plugin_polling_answer";
	public static final String INTENT_ACTION_RESULT = "hu.edudroid.ict.plugin_polling_answer";
