...
public class ServeJarServlet extends HttpServlet {
	/**
	 * 
	 */
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res)
    	...
    	Filter moduleFilter = new FilterPredicate(Constants.MODULES_JAR_FILE_KEY_COLUMN, FilterOperator.EQUAL, req.getParameter("blob-key"));
